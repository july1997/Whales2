...
public struct BoidSnapshotData : ISnapshotData<BoidSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref BoidSnapshotData baseline1, ref BoidSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref BoidSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Interpolate(ref BoidSnapshotData target, float factor)
    {
