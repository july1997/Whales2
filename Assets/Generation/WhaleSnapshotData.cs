...
public struct WhaleSnapshotData : ISnapshotData<WhaleSnapshotData>
{
    public uint tick;
    ...
    public void Deserialize(uint tick, ref WhaleSnapshotData baseline, ref DataStreamReader reader,
